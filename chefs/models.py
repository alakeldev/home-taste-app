...
class Profile(models.Model):
    ...
    email = models.EmailField(("Contact Email"), max_length=50, help_text='You can enter a different email from the one used during registration.', default="Not Set")
    phone_number = models.CharField(("Phone Number"), max_length=25, help_text='Please provide your contact phone/mobile number.', default="Not Set")
    cuisine_specialization = models.CharField(("Cuisine Type"), max_length=25, help_text='Please specify one or two cuisines from your culinary expertise (e.g., Indian, Syrian, Italian)', default="Not Set")
    Region = models.CharField(("Region"), choices=REGION, default='Europe', help_text='Please specify your region.')
    country = models.CharField(("Country"), max_length=12, help_text='Please enter your country of residence (use abbreviations if its long).', default="Not Set")
    city = models.CharField(("City"), max_length=12, help_text='Please enter your city of residence (use abbreviations if its long).', default="Not Set")
    created_on = models.DateTimeField(auto_now_add=True)
    slug = models.SlugField(blank=True, null=True)
    gender = models.CharField(choices = GENDER, help_text='Please specify your gender.', default="Not Set")
    instructions = RichTextField(("Please Share Below Your Cook Instructions/Schedules"), max_length=6000, default="Not Set")
